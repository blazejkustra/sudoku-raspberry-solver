...
X_train, X_test, y_train, y_test = train_test_split(
    images, class_numbers, test_size=test_ratio)
...
assert (X_train.shape[1:] ==
        image_dimensions), " The dimesions of the Training images are wrong "
assert (X_validation.shape[1:] ==
        image_dimensions), " The dimesionas of the Validation images are wrong "
assert (X_test.shape[1:] ==
        image_dimensions), " The dimesionas of the Test images are wrong"
...
fig, axs = plt.subplots(nrows=number_of_classes,
                        ncols=cols, figsize=(5, number_of_classes))
fig.tight_layout()
...
# ITERATE AND PREPROCESS ALL IMAGES
